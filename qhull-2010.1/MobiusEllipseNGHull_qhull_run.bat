...
qvoronoi<MobiusEllipseNGHullmeshless_input.txt Qt s o Fv TO MobiusEllipseNGHullvoronoi_input.txt
qdelaunay<MobiusEllipseNGHullmeshless_input.txt Qt i Fa TO MobiusEllipseNGHulldelaunay_input.txt
