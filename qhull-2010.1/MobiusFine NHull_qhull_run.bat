...
qvoronoi<MobiusFine NHullmeshless_input.txt Qt s o Fv TO MobiusFine NHullvoronoi_input.txt
qdelaunay<MobiusFine NHullmeshless_input.txt Qt i Fa TO MobiusFine NHulldelaunay_input.txt
